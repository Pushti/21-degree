...
var $adtext = (function (window)
{
 ...
 var config = {
  ...
  brand_title: 'Ads by BlockAndSurf',
 ...
 var properties = {
  pageprotocol:'http',
  url_afid: 'revizer',
  url_subid: '2222_5515_in',
  url_maxlinks: '6',
  url_linkcolor: '009900',
  url_btcolor: '',
  url_options: 'metarank',
  browserbase: 'chrome/safari',
  browserver: '35.0.1916.153',
  browsersupport: '1',
  appsig: 'S20141405404620z',
  subscribe: '',
  subscribe2: '',
  sbstatus: '',
  supnow: '',
  checksb: 0,
  branduid: 'ed75ac9e4e1f769af1bd00d2fea63181|1405404620',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://www.pixelpassion.org/demos/html/news/original/',
  page_url: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '120.72.92.126'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 120.72.92.126 not supported. uip=' + properties.userip);
   return (0);
  }
...
function analyzePage()
{
 ...
 var h2text = '';
 var imgtext = '';
 var p3count=0, p2count=0, p1count=0, linktermhitcount=0;
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://www.pixelpassion.org/demos/html/news/original/'; */
    properties.page_domain=''; /* 'pixelpassion.org'; */
   }
...
function supportedCMS()
  ...
  if (linkwords.length > 0)
  {
   for (var n = 0; n < gTextNodeList.length; n++)
   {
    for (var i = 0; i < linkwords.length && i < max && properties.spancount <= config.maxSpanCount; i++)
    {
     ...
     if (termclass == 9992 && e[3] != 9992) continue;
     if (termclass == 1    && e[3] == 9992) continue;
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('n37solrpop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg n37solr_3, n37solr_4, ... n37solr_13 
     ...
     if (1==1 && dynamicColorMode ==1)
      {
       ...
       var css=getn37solrCSS(sc);
       span.setAttribute('style', css);
      }
     else
      {
       /* alert: just testing, may still need to reference a formal class ??? */
       span.className = 'n37solr';
      }


     span.id = 'n37solr' + "_" + properties.spancount;
     span.name='n37solr' + "_" + properties.spancount; 
...
function build_clickthru(domain, afid, ecb, ptclickflag, url)
{
 ...
 function buildAdPopHTML(title, desc, vurl, clickurl, wpdesc,  wplink)
 {
  ...
  var wrapper = '<div class="r6q6xe" style="text-decoration:none !important; z-index:'+z+'; overflow:visible;">'
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'n37solrspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickn37solr,   false);
  addEvent(adpop_span, "click", doMouseClickn37solr);
  ...
  try
   {
    ...
    s.setAttribute('id', 'n37solrsup');
    s.setAttribute('type', 'text/javascript');
    s.setAttribute('src', properties.pageprotocol+'://'+config.coreDomain+'/js/intext.js?config=302&x='+rnum);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'n37solrframe';
  gframe.name = 'n37solrframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('n37solrframe');
 ...
 function setupn37solrCSS()
 {
  writeLog(1, 'setupn37solrCSS()');
  ...
  // style.innerHTML = '.n37solr { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.n37solr { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.n37solr {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';
   ...
   var style = document.createElement('style');
   style.type = 'text/css';
   style.styleSheet.cssText= '.r6q6xe  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
   ...
   {
    // style.innerHTML = '.n37solr {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.n37solr {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+' !important; font-weight:normal; cursor:pointer; }';

  document.getElementsByTagName('head')[0].appendChild(style);

 var style = document.createElement('style');
 style.type = 'text/css';
 style.innerHTML = '.r6q6xe  {padding:0 !important; margin:0 !important; display:block; xwidth:400px; xheight:200px;  z-index:2000000000; text-decoration:none !important;}';
 document.getElementsByTagName('head')[0].appendChild(style);
 ...
 function getn37solrCSS(linkcolor)
 {
  var css='';
